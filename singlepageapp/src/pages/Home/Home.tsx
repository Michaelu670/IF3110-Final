...
import AcceptUser from "@/components/SubscriptionStatus/AcceptUser";
import RejectUser from "@/components/SubscriptionStatus/RejectUser";
...
const Home = () => {
    ...
    const [mainComponent, setMainComponent] = useState<React.ReactNode>(<SubscriptionRequest />);
    ...
    const handleNavbarItemClick = (text: string) => {
        console.log('Clicked:', text);
        if (text === "Subscription Request") {
            setMainComponent(<SubscriptionRequest />);
        } else if (text === "Accepted User") {
            setMainComponent(<AcceptUser />);
        } else if (text === "Rejected User") {
            setMainComponent(<RejectUser />);
